...
import { useProductStore } from '@/stores/client/product/product';
        ...
        <ul v-if="productStore.productVariants">
            <li v-for="(productVariant, index) in productStore.productVariants" :key="index">
                ...
                <div v-if="authServ.userRole === 'client'">
                    <button @click="addToCart(productStore.productDetail!, productVariant)"
                        ...
                        to cart</button>
                    <button @click="wishlistServ.addToWishlist(productVariant!)"
