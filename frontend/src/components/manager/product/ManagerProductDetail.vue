...
<template>
    <div v-if="productStore.productDetail" class="max-w-md mx-auto bg-white shadow-md rounded px-4 py-6">
        ...
        <ul v-if="productStore.productVariants">
            <li v-for="(productVariant, index) in productStore.productVariants" :key="index">
                ...
                <button @click="productStore.deleteVariant(productVariant!.id)"
