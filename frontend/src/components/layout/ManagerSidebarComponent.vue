    ...
    <aside id="default-sidebar" class="relative z-40 w-64 h-dvh transition-transform -translate-x-full sm:translate-x-0 pt-[110px] sm:pt-[110px] md:pt-[110px] lg:pt-[110px]" aria-label="Sidenav">
        <div class="py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <ul class="space-y-2">
                ...
                <li>
                    <RouterLink :to="{ name: 'manager.orders.all' }" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <RouterLink :to="{ name: 'manager.products.all' }" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
