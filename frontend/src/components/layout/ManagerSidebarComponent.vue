...
<template>
    ...
    <aside id="default-sidebar" class="relative z-40 w-64 h-dvh transition-transform -translate-x-full sm:translate-x-0 pt-[112px] sm:pt-[112px] md:pt-[112px] lg:pt-[116px]" aria-label="Sidenav">
