                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="shippingStore.shippingCreate(shipping)">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full px-3">
                                ...
                                <input type="number" name="apartment" id="apartment" v-model="shipping.apartment_number" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" />
                            </div>
