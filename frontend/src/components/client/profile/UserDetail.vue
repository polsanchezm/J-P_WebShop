...
<template>
    <div v-if="authServ.user" class="max-w-md mx-auto bg-white shadow-md rounded px-4 py-6">
        ...
        <div>
            ...
            <p class="text-gray-700"><span class="font-semibold">Surnames:</span> {{ authServ.user!.surnames }}</p>
            <p class="text-gray-700"><span class="font-semibold">Birthdate:</span> {{ formatDate(authServ.user!.birthdate) }}</p>
