            ...
            <div v-if="authStore.user" class="w-full">
                <div class="flex flex-col items-center p-6 w-full mt-6">
                    ...
                    <div class="mt-6 flex justify-around w-full max-w-2xl">
                        <RouterLink v-if="authStore.user.role === 'client'" :to="{ name: 'user.edit' }" class="mr-3 w-1/3 py-4 text-white bg-gray-700 hover:bg-gray-900 focus:outline-none font-medium rounded-lg text-base px-5 text-center transition-colors"> Edit</RouterLink>
                        ...
                        <button v-if="authStore.user.role === 'client'" @click="authStore.deleteUser()" class="ml-3 w-1/3 py-4 text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 focus:outline-none font-medium rounded-lg text-base px-5 text-center transition-colors">Delete</button>
                    </div>
                </div>
            </div>
        </div>
