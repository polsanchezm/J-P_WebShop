                    ...
                    <form class="max-w-md mx-auto" @submit.prevent="onSubmit">
                        <div class="relative z-0 w-full mb-5 group">
                            <Field name="name" v-slot="{ field, meta }">
                                <input type="text" id="floating_name" v-bind="field" v-model="authServ.user.value!.name" class="block py-2.5 px-0 w-full text-sm text-metal-600 border-metal-600 focus:border-metal-950 dark:text-ecru-50 dark:border-ecru-300 dark:focus:border-ecru-50 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <Field name="surnames" v-slot="{ field, meta }">
                                <input type="text" id="floating_surnames" v-bind="field" v-model="authServ.user.value!.surnames" class="block py-2.5 px-0 w-full text-sm text-metal-600 border-metal-600 focus:border-metal-950 dark:text-ecru-50 dark:border-ecru-300 dark:focus:border-ecru-50 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <Field name="email" v-slot="{ field, meta }">
                                <input type="text" id="floating_email" v-bind="field" v-model="authServ.user.value!.email" class="block py-2.5 px-0 w-full text-sm text-metal-600 border-metal-600 focus:border-metal-950 dark:text-ecru-50 dark:border-ecru-300 dark:focus:border-ecru-50 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " required />
