...
const loggedUser = userStore.userDetail().then(loggedUser => {
    ...
    user.value.birthdate = loggedUser.birthdate;
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1
                        ...
                        Edit details</h1>
                    <form class="space-y-4 md:space-y-6" @submit.prevent="userStore.userEdit(user)">
                        <div>
                        ...
                        <div>
                            <label for="confirm-password"
                                ...
                                password</label>
                            <input type="password" v-model="user.password_confirmation" name="confirm-password"
