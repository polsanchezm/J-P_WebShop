...
<template>
    <section>
        <div class="flex flex-col items-center justify-center min-h-screen">
            <div class="flex flex-col w-full h-dvh bg-gray-50 items-center pt-3 lg:pt-0 mt-20 dark:bg-corduroy-900">
                <div class="bg-gray-400 dark:bg-gray-700 p-5 mt-3 w-full">
