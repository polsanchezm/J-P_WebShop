                    ...
                    <form @submit.prevent="userStore.userRegister(user)" class="space-y-4 md:space-y-6">
                        ...
                        <div>
                            <label for="birthdate"
                                ...
                                birthdate</label>
                            <!-- <input type="text" v-model="surnames" v-bind="surnamesAttrs" name="surnames" id="surnames" -->
                            <input type="date" v-model="user.birthdate" name="birthdate" id="birthdate"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                            <!-- <span v-if="errors.surnames" class="text-red-500">{{ errors.surnames }}</span> -->
                        ...
                        <div>
                            ...
                            <input type="password" v-model="user.currentPassword" name="password" id="password"
                                placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
                        ...
                        <div>
                            ...
                            <input type="password" v-model="user.currentPasswordConfirmation"
                                name="passwordConfirmation" id="password_confirmation" placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required />
