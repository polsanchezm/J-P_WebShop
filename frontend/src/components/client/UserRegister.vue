                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="authStore.userRegister(user)" class="space-y-4 md:space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" v-model="user.name" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John" required />
                        ...
                        <div>
                            ...
                            <!-- <input type="text" v-model="surnames" v-bind="surnamesAttrs" name="surnames" id="surnames" -->
                            <input type="date" v-model="user.birthdate" name="birthdate" id="birthdate" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                            <!-- <span v-if="errors.surnames" class="text-red-500">{{ errors.surnames }}</span> -->
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
                            <!-- <input type="email" v-model="email" v-bind="emailAttrs" name="email" id="email" -->
                            <input type="email" v-model="user.email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="johnDoe@mail.com" required />
                            <!-- <span v-if="errors.email" class="text-red-500">{{ errors.email }}</span> -->
                        </div>
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                            <!-- <input type="password" v-model="password" v-bind="passwordAttrs" name="password" -->
                            <input type="password" v-model="user.currentPassword" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                        ...
                        <div>
                            ...
                            <input type="password" v-model="user.currentPasswordConfirmation" name="passwordConfirmation" id="password_confirmation" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            ...
                            <RouterLink :to="{ name: 'login' }" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here </RouterLink>
                        </p>
                    </form>
                </div>
            </div>
